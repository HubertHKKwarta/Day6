...
string connectionString =
            "Server = tcp:volleyballservhk.database.windows.net,1433;Initial Catalog = VolleyballD8; Persist Security Info=False;User ID = hubert; Password=Topolowa32; MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout = 30";
